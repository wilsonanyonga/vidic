...
part of 'get_tenant_letter2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DatumTenantLetter _$DatumTenantLetterFromJson(Map<String, dynamic> json) =>
    DatumTenantLetter(
      id: json['ID'] as int,
      ...
      lettersTenantTypes: (json['LettersTenantTypes'] as List<dynamic>)
          .map((e) => LettersTenantType.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$DatumTenantLetterToJson(DatumTenantLetter instance) =>
    <String, dynamic>{
      'ID': instance.id,
