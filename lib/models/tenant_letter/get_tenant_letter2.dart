...
part 'get_tenant_letter2.g.dart';

@JsonSerializable()
class DatumTenantLetter {
  DatumTenantLetter({
    required this.id,
  ...
  List<LettersTenantType> lettersTenantTypes;

  factory DatumTenantLetter.fromJson(Map<String, dynamic> json) =>
      _$DatumTenantLetterFromJson(json);

  Map<String, dynamic> toJson() => _$DatumTenantLetterToJson(this);
}
