...
part of 'get_letter2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DatumLetter _$DatumLetterFromJson(Map<String, dynamic> json) => DatumLetter(
      id: json['ID'] as int,
      ...
      lettersTypes: (json['LettersTypes'] as List<dynamic>)
          .map((e) => LettersType.fromJson(e as Map<String, dynamic>))
          .toList(),
      lettersTenantTypes: json['LettersTenantTypes'],
    );

Map<String, dynamic> _$DatumLetterToJson(DatumLetter instance) =>
    <String, dynamic>{
      'ID': instance.id,
